...
- **配信**: 平日 09:50 JST（GitHub Actions schedule。土日 / 日本の祝日 / 年末年始 12/29〜1/3 は自動スキップ）
...
- `.github/workflows/daily.yml` — cron `50 0 * * 1-5`（UTC 月〜金 00:50 = JST 09:50）+ `workflow_dispatch`
